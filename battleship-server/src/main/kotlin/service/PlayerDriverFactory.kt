...
class InProcessRandomPlayerDriver(
    ...
    override suspend fun requestField(gameId: BattleshipGameId): BattleshipField {
        ...
        return BattleshipField.fromShips(
            ...
            BattleshipType.SUBMARINE to listOf(BattleshipPos(1, 0), BattleshipPos(1, 1), BattleshipPos(1, 2)),
            BattleshipType.DESTROYER to listOf(BattleshipPos(2, 0), BattleshipPos(2, 1), BattleshipPos(2, 2)),
            BattleshipType.BATTLESHIP to listOf(
                BattleshipPos(3, 0),
                BattleshipPos(3, 1),
                BattleshipPos(3, 2),
                BattleshipPos(3, 3)
            ),
            BattleshipType.CARRIER to listOf(
                BattleshipPos(4, 0),
                BattleshipPos(4, 1),
                BattleshipPos(4, 2),
                BattleshipPos(4, 3),
    ...
    override suspend fun requestStrike(
        ...
        return BattleshipPos(Random.nextInt(otherField.field.size), Random.nextInt(otherField.field.size))
    }
}
